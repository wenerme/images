...
sync-image registry.opensource.zalan.do/acid/spilo-14 $(github-latest-version zalando/spilo)
...
sync-image k8s.gcr.io/ingress-nginx/controller v1.1.3
#sync-image k8s.gcr.io/ingress-nginx/kube-webhook-certgen v1.1.1
